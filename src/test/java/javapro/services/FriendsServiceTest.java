...
@PrepareForTest(FriendsService.class)
class FriendsServiceTest {
    ...
    void deleteFriendSuccess() throws Exception {
        ...
        // subs
        when(personRepository.findUserIdByEmail(eq("dev"))).thenReturn(person);
        FriendsService friendsServiceTest = PowerMockito.spy(new FriendsService(personRepository, mapper,
        friendshipRepository, notificationEntityRepository, notificationRepository, logger));
        PowerMockito.when(friendsServiceTest, "checkPersonByEmail").thenReturn(person);
